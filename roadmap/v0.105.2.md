...
Released status records publication. The work and exit criteria below describe
the intended qualification and do not establish that every check ran. The
[post-release assessment](../pg-trickle-v0.105.2-assessment.md) distinguishes
packaged Linux runtime tests from unproven all-platform runtime, active-data
upgrade, foreground-write, and independent operator claims.

[v0.105.3](v0.105.3.md) addresses the known DVM and publication-gating defects.
[v0.106.0](v0.106.0.md) closes execution-evidence gaps, and
[v0.107.0](v0.107.0.md) verifies support documentation and operator procedures.
