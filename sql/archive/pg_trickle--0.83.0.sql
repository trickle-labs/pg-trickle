...
CREATE TABLE IF NOT EXISTS pgtrickle.pgt_stream_tables (
    ...
    -- v0.83.0: Composite row-identity encoding version.
...
-- v0.83.0: Durable private state registry for guarded set operations.
