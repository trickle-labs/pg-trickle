[32m[1m       Using[0m[39m [37m[1mDefaultFeature("pg18")[0m[39m and `pg_config` from [36m/opt/homebrew/bin/pg_config[39m
[32m[1m    Building[0m[39m for SQL generation with features `pg18`
   Compiling pg_trickle v0.78.0 (/Users/geir.gronmo/projects/pg-trickle1)
