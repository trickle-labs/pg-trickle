...
|--------|-----------|-------------|---------|
| `PLAN_` | Implementation plan with concrete phases, steps, and acceptance criteria. | You know *what* to build and need to describe *how*. | `PLAN_STRATIFICATION.md`, `PLAN_VERSIONING.md` |
